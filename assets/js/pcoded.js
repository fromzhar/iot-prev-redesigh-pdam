...
// Ensure header dropdowns fit within viewport: shift left if clipped on the right
$(document).on('shown.bs.dropdown', '.pcoded-header .dropdown', function () {
    try {
        ...
        if (overflow > 0) {
            var shift = overflow + 12; // 12px breathing room
...
$.ripple(".btn, .pcoded-navbar a, .pcoded-header .navbar-nav > li > .dropdown > a, .pcoded-header .navbar-nav > li.drp-user > a, .page-link, .nav .nav-link", {
